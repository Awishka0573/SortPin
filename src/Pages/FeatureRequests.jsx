  ...
  return (
    <section className="min-h-screen bg-gray-50 flex justify-center py-10 px-4">
      <div className="w-full max-w-6xl bg-white shadow-sm rounded-xl p-6 flex flex-col md:flex-row gap-6 border border-gray-200">
        ...
        <aside className="md:w-1/4 w-full border border-gray-100 rounded-lg p-4 overflow-y-scroll max-h-[75vh] bg-gray-50">
          {posts.map((post, index) => (
            <div
              key={index}
              className="mb-4 bg-white rounded-md p-3 shadow-sm hover:shadow-md transition-all"
            >
              ...
              <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
                ...
                <button className="bg-gray-100 px-2 py-1 rounded hover:bg-gray-200 transition">
                  ↑
                </button>
              </div>
            </div>
